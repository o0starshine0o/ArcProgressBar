...
open class BezierMaskView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defAttr: Int = 0) :
    ConstraintLayout(context, attrs, defAttr) {
    ...
    protected fun updatePath(path: Path, excludeRadius: Float = 8f): Path {
